...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Floci-Local%20Emulator-4CAF50?style=for-the-badge" />
</p>
...
> 💡 **Why Floci?** Floci emulates the AWS API locally using Docker, enabling full infrastructure testing without incurring any cloud costs — ideal for local development and CI pipelines.
...
|--------------------|--------------------------|---------|
| Terraform `>= 1.0` | Infrastructure provisioning | [Download](https://developer.hashicorp.com/terraform/install) |
| Docker             | Required by Floci        | [Download](https://docs.docker.com/get-docker/) |
| Floci              | Local AWS emulator       | [floci.dev](https://floci.dev) |
| AWS CLI *(optional)* | Inspect outputs manually | [Download](https://aws.amazon.com/cli/) |
...
> ℹ️ `terraform.tfstate` is intentionally excluded via `.gitignore` as it contains generated resource IDs and infrastructure state.
